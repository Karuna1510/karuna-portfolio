...
const experiences = [
  {
    ...
    summary:
      'Building and enhancing mailchimp.com — high-traffic, customer-facing experiences powered by React, TypeScript, and Contentful CMS, with a strong focus on mobile performance, experimentation, and engineering quality.',
    quote:
    ...
    highlights: [
      'Contentful-driven feature development — Built and shipped new customer-facing features on the Mailchimp dotcom platform using React, TypeScript, and SCSS, integrating with Contentful CMS to enable flexible, content-managed component creation and accelerate page authoring velocity.',
      'Mobile performance and Web Vitals optimization — Identified and resolved Interaction to Next Paint (INP) and Largest Contentful Paint (LCP) bottlenecks on mobile web, improving both metrics by 35–40% and delivering a measurably faster, more responsive experience across high-traffic Mailchimp pages.',
      'Experimentation and A/B testing — Developed and launched A/B experiments across key user journeys, driving measurable improvements in engagement and click-through rates and enabling data-informed product decisions.',
      'Frontend architecture and design system alignment — Modernized frontend components in alignment with Mailchimp\'s design system, improving rendering efficiency, type safety through TypeScript adoption, and long-term maintainability.',
      'Automated testing — Maintained end-to-end test coverage using Playwright across critical user journeys, reducing regressions during frequent release cycles.',
      'Code quality and team collaboration — Conducted regular PR reviews for the team, upholding engineering standards and contributing to a culture of quality across a cross-functional product team.',
    ],
    tech: [
      'React',
      'TypeScript',
