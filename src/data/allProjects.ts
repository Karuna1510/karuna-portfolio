...
export const allProjectsFull: FullProject[] = [
  {
    ...
    title: 'Mailchimp.com',
    description:
      'Built and enhanced high-traffic, customer-facing experiences on the Mailchimp marketing website using React, JavaScript, and SCSS, with growing TypeScript adoption. Shipped experiments and A/B tests, improved Interaction to Next Paint (INP) on mobile, and maintained Playwright end-to-end coverage for critical user journeys. Partnered with product, design, and engineering on design-system-aligned components and performance-focused releases.',
    highlights: [
      'High-traffic marketing surfaces',
      'Experimentation & A/B testing',
      'INP optimization & Playwright E2E',
